...
${TESTDIR}/tests/GridTest.o: tests/GridTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GridTest.o tests/GridTest.cpp
...
${OBJECTDIR}/Solver_nomain.o: ${OBJECTDIR}/Solver.o Solver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Solver_nomain.o Solver.cpp;\
	else  \
