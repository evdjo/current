...
${OBJECTDIR}/SudokuModel.o: SudokuModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SudokuModel.o SudokuModel.cpp
...
${TESTDIR}/tests/CellPossibleValuesTest.o: tests/CellPossibleValuesTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CellPossibleValuesTest.o tests/CellPossibleValuesTest.cpp


${TESTDIR}/tests/SudokuTestRunner.o: tests/SudokuTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SudokuTestRunner.o tests/SudokuTestRunner.cpp
...
${OBJECTDIR}/SudokuModel_nomain.o: ${OBJECTDIR}/SudokuModel.o SudokuModel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SudokuModel_nomain.o SudokuModel.cpp;\
	else  \
